...
$urvenue_ws_eventdataandeczmap = urvenue_ws_get_event($urvenue_ws_eventcode, array("returnecozonesmap" => 1));
...
$urvenue_ws_inventorylist = urvenue_ws_get_eventinventory_list($urvenue_ws_eventdata, array("ecozonesmap" => $urvenue_ws_eventdataandeczmap));
...
if($urvenue_ws_returntempl){
    $urvenue_ws_templs = array(
        ...
        "item-list-remove" => urvenue_ws_get_template("inventory/item-list-remove"),
    );
