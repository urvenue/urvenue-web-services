...
$urvenue_ws_admin_optstabs_state = urvenue_ws_adm_get_boxtabs_state($urvenue_ws_initialtab);
...
<div class="uvs-boxpanel uvs-boxpanel-admin <?php echo esc_attr( $urvenue_ws_boxpanelclass ); ?>">
	<form id="uvs-uvcoreadmin-form" action="<?php echo esc_url( $urvenue_ws_adm_admin_lib["loads"]["adminsave"] ); ?>">
		...
		<div class="uvs-adminbox-admcols uvs-clearfix">
			...
			<ul>
					<li class="uvs-menu-group"><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state['dashboard'] ); ?>" href="#dashboard"><span><i class="uwsicon-gauge"></i> Dashboard</span></a></li>

					<li class="uvs-menu-group"><span><i class="uwsicon-calendar-1"></i> Events</span></li>
					<li><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state['events-global'] ); ?>" href="#events-global">Global</a></li>
					<li class="uvissubitem"><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state['events-calendar'] ); ?>" href="#events-calendar">Calendar</a></li>
					<li class="uvissubitem"><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state['events-agenda'] ); ?>" href="#events-agenda">Agenda</a></li>
					<?php /* old: <li class="uvissubitem"><a class="[echo $urvenue_ws_admin_optstabs_state[events-list]]" href="#events-list">List</a></li> */ ?>
					<li class="uvissubitem"><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state['events-slider'] ); ?>" href="#events-slider">Slider</a></li>
					<li><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state['events-event'] ); ?>" href="#events-event">Event Page</a></li>
					<li><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state['flyers'] ); ?>" href="#flyers">Flyers</a></li>
					...
					<li><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state['pages'] ); ?>" href="#pages">Pages</a></li>
					<li><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state['venues'] ); ?> uvs-menu-isvenues" href="#venues">Venues</a></li>
					<li><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state['inventory'] ); ?>" href="#inventory">Inventory</a></li>
					<li><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state['notifications'] ); ?>" href="#notifications">Notifications</a></li>
					<li><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state['map'] ); ?>" href="#map">Map</a></li>
					<li><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state["ui-color-palette"] ); ?> uvs-menu-isvenues" href="#ui-color-palette">UI Color Palette</a></li>
					<li><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state['seo'] ); ?>" href="#seo">SEO</a></li>
					<li><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state['cache'] ); ?>" href="#cache">Cache</a></li>
					<li><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state['api'] ); ?>" href="#api">API Info</a></li>
					<li><a class="<?php echo esc_attr( $urvenue_ws_admin_optstabs_state['status'] ); ?>" href="#status">System Status</a></li>
				</ul>
			</div>
