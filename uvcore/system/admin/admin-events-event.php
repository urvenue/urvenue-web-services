...
?>
<div id="uvs-admin-events-event" class="uvs-admin-opt-section <?php echo $uvs_admin_optstabs_state['events-event']; ?>">
	...
	<div class="uvs-infolist-item uvs-clearfix">
        ...
        <div class="uvsvalue">
            <?php echo $uvseventshowdigitalmenu; ?>
        </div>
    </div>
    <div class="uvs-infolist-item uvs-clearfix">
        <div class="uvsname">Show Summary</div>
        <div class="uvsvalue">
            <?php echo $uvseventshowsummary; ?>
        </div>
    </div>
    <div class="uvs-infolist-item uvs-clearfix">
