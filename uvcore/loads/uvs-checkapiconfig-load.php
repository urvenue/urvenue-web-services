    ...
    if($urvenue_ws_adm_microcodefeed["uv"]["success"]["status"] == "error"){
        ...
        if(is_array($urvenue_ws_adm_venues) and count($urvenue_ws_adm_venues)){
            ...
            foreach($urvenue_ws_adm_venues as $urvenue_ws_adm_venue){
                ...
                $urvenue_ws_adm_venueforminfo = "<input class='uvsjson' type='hidden' name='venues[$urvenue_ws_adm_venuewbcode][venuekey]' value='$urvenue_ws_adm_venuewbcode'>";
                $urvenue_ws_adm_venueforminfo .= "<input class='uvsjson' type='hidden' name='venues[$urvenue_ws_adm_venuewbcode][manageentid]' value='$urvenue_ws_adm_manageentid'>";
                $urvenue_ws_adm_venueforminfo .= "<input class='uvsjson' type='hidden' name='venues[$urvenue_ws_adm_venuewbcode][providerid]' value='$urvenue_ws_adm_providerid'>";
                $urvenue_ws_adm_venueforminfo .= "<input class='uvsjson' type='hidden' name='venues[$urvenue_ws_adm_venuewbcode][resellerid]' value='$urvenue_ws_adm_resellerid'>";
                $urvenue_ws_adm_venueforminfo .= "<input class='uvsjson' type='hidden' name='venues[$urvenue_ws_adm_venuewbcode][venuename]' value='$urvenue_ws_adm_venuename'>";
                $urvenue_ws_adm_venueforminfo .= "<input class='uvsjson' type='hidden' name='venues[$urvenue_ws_adm_venuewbcode][venuecode]' value='VEN$urvenue_ws_adm_venueveaid'>";
                ...
                $urvenue_ws_adm_venueidhtml = ($urvenue_ws_adm_venueuvid) ? "<div class='uvs-infolist-item uvs-clearfix'><div class='uvsname'>Venue ID:</div><div class='uvsvalue'>$urvenue_ws_adm_venueuvid</div></div>" : "";
                $urvenue_ws_adm_clientidhtml = ($urvenue_ws_adm_venueclientid) ? "<div class='uvs-infolist-item uvs-clearfix'><div class='uvsname'>Client ID:</div><div class='uvsvalue'>$urvenue_ws_adm_venueclientid</div></div>" : "";
                $urvenue_ws_adm_serverhtml = ($urvenue_ws_adm_venueserver) ? "<div class='uvs-infolist-item uvs-clearfix'><div class='uvsname'>UrVenue Server:</div><div class='uvsvalue'>$urvenue_ws_adm_venueserver</div></div>" : "";

                $urvenue_ws_venuealiasinput = "<div class='uvs-infolist-item uvs-clearfix'><div class='uvsname'>Use Alias as Venue Name:</div><div class='uvsvalue'><div class='uvs-switch-ui'><button class='uvsjs-trigger-switch' type='button'><span class='uvs-lb-on'>Yes</span><span class='uvs-lb-off'>No</span></button><input class='uvsjson' type='hidden' name='venues[$urvenue_ws_adm_venuewbcode][venueforcealias]' value='' data-value-on='1' data-value-off=''></div></div></div>";

                $urvenue_ws_hideeventsinput = "<div class='uvs-infolist-item uvs-clearfix'><div class='uvsname'>Hide Events:</div><div class='uvsvalue'><div class='uvs-switch-ui'><button class='uvsjs-trigger-switch' type='button'><span class='uvs-lb-on'>Yes</span><span class='uvs-lb-off'>No</span></button><input class='uvsjson' type='hidden' name='venues[$urvenue_ws_adm_venuewbcode][venuehideinevents]' value='' data-value-on='1' data-value-off=''></div></div></div>";
